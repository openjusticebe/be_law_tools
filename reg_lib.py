...
RE_FORMATS = [
    ...
    (r"^\u00A0{2}LIVRE (?P<num>[\dIVL]{1,5}(er|re)?)\.( - )?(?P<txt>.*)$", "# Livre \g<num> \g<txt>"),
    (r"^\u00A0{2}TITRE (?P<num>[\dIVL]{1,5}(er|re)?)\.( - )?(?P<txt>.*)$", "## Titre \g<num> \g<txt>"),
    (r"^\u00A0{2}CHAPITRE (?P<num>[\dIVL]{1,5}(er|re)?)\.( - )?(?P<txt>.*)$", "### Chapitre \g<num> \g<txt>"),
    (r"^\u00A0{2}Chapitre (?P<num>[\dIVL]{1,5}(er|re)?)\.( - )?(?P<txt>.*)$", "### Chapitre \g<num> \g<txt>"),
    (r"^\u00A0{2}SECTION (?P<num>[\dIVL]{1,3}(er|re)?)\.(?P<txt>.*)$", "#### Section \g<num> \g<txt>"),
    (r"^\u00A0{2}Section (?P<num>[\dIVL]{1,3}(er|re)?)\.(?P<txt>.*)$", "#### Section \g<num> \g<txt>"),
    (r"^\u00A0{2}\s*-\s*", " * "),
